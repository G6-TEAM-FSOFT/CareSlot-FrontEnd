    ...
    <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4 text-xs">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-300 rounded-xl p-2.5 text-slate-900 font-bold focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 outline-none shadow-sm"
          />
        </div>
      ...
      <div className="space-y-1.5 text-xs">
        ...
        <textarea
          ...
          className="w-full bg-white border border-slate-300 rounded-xl p-2.5 text-slate-900 font-mono outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 shadow-sm"
        />
      </div>
