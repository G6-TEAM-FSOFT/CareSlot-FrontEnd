            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs">
              <div className="space-y-0.5">
                ...
                <span className="font-extrabold text-emerald-700 flex items-center gap-1">
                  ...
                  {selectedApt.slot?.doctor?.fullName || selectedApt.doctorName || 'BS. Chuyên Khoa'}
                </span>
              </div>

              <div className="space-y-0.5">
                <span className="text-[10px] text-slate-500 font-bold uppercase tracking-wider block">Phòng / Chuyên khoa:</span>
                <span className="font-bold text-slate-800 flex items-center gap-1">
                  <MapPin className="w-3.5 h-3.5 text-slate-500 flex-shrink-0" />
                  {selectedApt.roomName || selectedApt.specialtyName || 'Phòng khám Ngoại Trú'}
                </span>
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              {isConfirmedTab && (
                <button
                  ...
                  onClick={onSaveProfileAndCheckIn}
                  className="px-5 py-2.5 bg-gradient-to-r from-cyan-600 to-emerald-600 hover:from-cyan-500 hover:to-emerald-500 font-extrabold text-white text-xs rounded-xl shadow-md active:scale-95 transition flex items-center gap-2"
                >
